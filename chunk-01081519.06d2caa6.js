(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-01081519"], {
    "06d5": function (e, t, a) {
        ...
        var r = function () {
            ...
            }, [e._v("添加")]) : e._e(), 2 != e.$store.getters.userInfo.userType ? a("el-popconfirm", {
                attrs: {title: "确定删除吗?"},
            ...
            })), 1)], 1), a("el-form-item", {attrs: {label: "学生姓名:"}}, [a("el-input", {
                attrs: {
                    placeholder: "请输入学生姓名",
                    size: "small"
                }, model: {
            ...
            name: "TeacherManage", data: function () {
                return {
                    ...
                    rules: {
                        ...
                        name: [{required: !0, message: "必须输入姓名"}],
                        gender: [{required: !0, message: "必须选择性别"}],
                        sno: [{required: !0, message: "必须输入学号"}],
                        ...
                        email: [{required: !0, message: "必须输入邮箱"}, {type: "email", message: "不是合法的邮箱格式"}],
                        telephone: [{required: !0, message: "必须输入电话"}, {
                            pattern: /^[1]([3-9])[0-9]{9}$/,
                            message: "不是合法的手机号格式"
                        }],
                        address: [{required: !0, message: "必须输入住址"}],
                        introducation: [{required: !0, message: "必须输入介绍"}],
